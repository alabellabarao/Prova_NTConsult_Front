...
<h4 class="subtitle">Passos para instalar o Cypress:</h4>
  ...
  <h4 class="subtitle">5 - Automação referente ao Projeto NT Consult, Escrever o Cenário 1 para Cadastro de cliente e Cenário 2 para Deletar o cliente cadastrado. </h4>
     <h2>Requisitos para Testes Automatizados</h2>
  <ul>
    <li>Utilizar BDD</li>
